...
a persistence unit "MitgliederbuchhaltungPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/at/mgl/Mitgliederbuchhaltung/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Mitgliederbuchhaltung/pom.xml":
...
artifact ("Mitgliederbuchhaltung.war") is already built. You can build
